...
<html lang="en">
 ...
 <body>
     ...
     <nav class="topnav" id="myTopnav">
       ...
       <a href="https://docs.google.com/document/d/1M8qDr-BjQ_R7MukT8qz7hQdG_5Bsc5Ysk6A6wEtsI4o/edit">Google Doc</a>
   ...
   <div class="wrapper">
       ...
       <h2 class="subheader">Contact Kacie</h2>
        ...
        $toName = "Kacie"; //place your client's name here
        $website = "IT 161 Contact Form Test";  //place NAME of your client's website
